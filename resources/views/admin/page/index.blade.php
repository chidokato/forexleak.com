...
<div class="d-sm-flex align-items-center justify-content-between mb-3 flex">
    ...
    <a class="add-iteam" href="{{route('page.create')}}"><button class="btn-success form-control" type="button"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</button></a>
</div>
                    ...
                    <table class="table">
                        ...
                        <tbody id="post-data">
                            ...
                            <tr id="post">
                                ...
                                <td>
                                    <div class="name"><a href="{{route('page.edit',[$val->id])}}" >{{$val->name}}</a></div>
                                ...
                                <td style="display: flex;">
                                    <a href="{{route('page.edit',[$val->id])}}" class="mr-2"><i class="fas fa-edit" aria-hidden="true"></i></a>
                                    <form action="{{route('page.destroy', [$val->id])}}" method="POST">
                                      @method('DELETE')
                                      @csrf
